...
!(function (e, t) {
  ...
  function W() {
    return xe || (V() && (xe = window.gsap) && xe.registerPlugin && xe);
  }
  function X(e) {
  ...
  function ua() {
    return !Re.length && xe.ticker.remove(sa);
  }
  function va(e) {
  ...
  function Ba(e) {
    (Me = e.touches && Ye < e.touches.length), ya(e.target, "touchend", Ba);
  }
  function Ca(e) {
    (Me = e.touches && Ye < e.touches.length), xa(e.target, "touchend", Ba);
  }
  function Da(e) {
    return (
      me.pageYOffset ||
  ...
  function Fa(e, t) {
    xa(e, "scroll", t), ze(e.parentNode) || Fa(e.parentNode, t);
  }
  function Ga(e, t) {
    ya(e, "scroll", t), ze(e.parentNode) || Ga(e.parentNode, t);
  }
  function Ia(e, t) {
      ...
      (this.calibrate = function (e) {
        ...
        (g = i.scrollTop),
          ...
          (r &&
            ...
            (u.width = "100%"),
            (u.paddingRight = v + "px"),
            k && (u.paddingBottom = t.paddingBottom),
            (a = i.clientWidth),
            (l = i.clientHeight),
            (m = i.scrollWidth),
            (y = i.scrollHeight),
  ...
  function Za(e) {
    if (V() && document.body) {
      ...
      (me = window),
        ...
        xa(ye, "contextmenu", function () {
          for (var e in Ae) Ae[e].isPressed && Ae[e].endDrag();
        }),
        (xe = be = W());
    }
    var n, o, r, i, a;
  ...
  function Draggable(h, p) {
    ...
    function vh(e) {
          ...
          te = !1,
            ...
            He.scrollLeft =
              null != me.pageXOffset
                ...
                : de.body.scrollLeft,
            r = q.pointerX - He.scrollLeft,
            i = q.pointerY - He.scrollTop;
          c && !n;

        )
          (t = (n = ze(c.parentNode)) ? He : c.parentNode),
            (o = n
              ? {
      ...
      if (P) {
        ...
        K
          ...
          : f
          ? (j && ((q.deltaY = u - f.top()), f.top(u)),
            $ && ((q.deltaX = p - f.left()), f.left(p)))
          : G
          ? (j && ((q.deltaY = u - parseFloat(se.y)), (se.y = u + "px")),
            $ && ((q.deltaX = p - parseFloat(se.x)), (se.x = p + "px")),
            se.renderTransform(1, se))
          : (j &&
          ...
          !g ||
            e ||
            F ||
            (!(F = !0) === Oa(q, "drag", "onDrag") &&
              ($ && (q.x -= q.deltaX), j && (q.y -= q.deltaY), vh(!0)),
            (F = !1));
      }
      P = !1;
    }
    function wh(e, t) {
      ...
      h._gsap || (se = xe.core.getCache(h)),
        ...
        G
          ...
          : ((q.y = parseFloat(h.style.top || ((o = La(h)) && o.top)) || 0),
        ...
        (O || k || _) &&
          ...
          (_ &&
            ((Fe.x = q.x),
            (Fe.y = q.y),
            (n = _(Fe)).x !== q.x && ((q.x = n.x), (P = !0)),
            n.y !== q.y && ((q.y = n.y), (P = !0))),
          O &&
            (n = O(q.x)) !== q.x &&
            ((q.x = n), K && (q.rotation = n), (P = !0)),
          k && ((n = k(q.y)) !== q.y && (q.y = n), (P = !0))),
        P && vh(!0),
        e ||
          ((q.deltaX = q.x - r),
          (q.deltaY = q.y - i),
          Oa(q, "throwupdate", "onThrowUpdate"));
    }
    function xh(a, l, s, n) {
      return (
        null == l && (l = -ke),
        ...
        X(a)
          ...
          : Pe(a)
          ? function (e) {
              for (var t, n, o = a.length, r = 0, i = ke; -1 < --o; )
                (n = (t = a[o]) - e) < 0 && (n = -n),
                  n < i && l <= t && t <= s && ((r = o), (i = n));
              return a[r];
            }
      ...
      (E = !1),
        f
          ? (f.calibrate(),
            ...
            (q.minY = L = -f.maxScrollTop()),
            (q.maxX = M = q.maxY = N = 0),
            (E = !0))
          : p.bounds &&
            ((e = Pa(p.bounds, h.parentNode)),
            K
              ? ((q.minX = S = e.left),
                (q.maxX = M = e.left + e.width),
                (q.minY = L = q.maxY = N = 0))
              : Z(p.bounds.maxX) && Z(p.bounds.maxY)
              ? ((t = Pa(h, h.parentNode)),
                (q.minX = S = Math.round(Ng(V, "px") + e.left - t.left)),
                (q.minY = L = Math.round(Ng(U, "px") + e.top - t.top)),
                (q.maxX = M = Math.round(S + (e.width - t.width))),
                (q.maxY = N = Math.round(L + (e.height - t.height))))
              : ((e = p.bounds),
                (q.minX = S = e.minX),
                (q.minY = L = e.minY),
                (q.maxX = M = e.maxX),
                (q.maxY = N = e.maxY)),
            M < S && ((q.minX = M), (q.maxX = M = S), (S = q.minX)),
            N < L && ((q.minY = N), (q.maxY = N = L), (L = q.minY)),
            K && ((q.minRotation = S), (q.maxRotation = M)),
            (E = !0)),
        p.liveSnap &&
          ((n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (o = Pe(n) || X(n)),
          K
            ? ((O = xh(o ? n : n.rotation, S, M, 1)), (k = null))
            : n.points
            ? (_ = (function buildPointSnapFunc(s, l, c, d, p, u, h) {
                return (
                  (u = u && u < ke ? u * u : ke),
                  X(s)
                    ? function (e) {
                    ...
                    ? function (e) {
                        for (
                          var t, n, o, r, i = s.length, a = 0, l = ke;
                          -1 < --i;
              ...
              })(o ? n : n.points, S, M, L, N, n.radius, f ? -1 : 1))
            : ($ &&
                (O = xh(
    ...
    function Ah() {
      (q.isThrowing = !1), Oa(q, "throwcomplete", "onThrowComplete");
    }
    function Bh() {
      q.isThrowing = !1;
    }
    function Ch(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ...
            (e = {
              resistance:
                (p.throwResistance || p.resistance || 1e3) / (K ? 10 : 1),
            }),
            K
              ? (e.rotation = Sa(q, o ? n : n.rotation, M, S, 1, t))
              : ($ &&
                  (e[V] = Sa(
                    q,
                ...
                (n.points || (Pe(n) && Y(n[0]))) &&
                  ((e.linkedProps = V + "," + U), (e.radius = n.radius)))),
          (q.isThrowing = !0),
    ...
    function Eh() {
      ...
      G &&
        ...
        (w = We.x),
        (b = We.y),
        P && (he(q.pointerX, q.pointerY), vh(!0)),
        (d = getGlobalMatrix(h)),
        f
          ? (zh(), (D = f.top()), (T = f.left()))
          : (pe() ? (wh(!0, !0), zh()) : q.applyBounds(),
            K
              ? ((e = h.ownerSVGElement
                ...
                (n = C.y - q.pointerY + i),
                (T = q.x),
                (D = q.y = Math.atan2(n, t) * Oe))
              : ((D = Ng(U, "px")), (T = Ng(V, "px")))),
        E &&
          o &&
          (M < T ? (T = M + (T - M) / o) : T < S && (T = S - (S - T) / o),
          K ||
            (N < D ? (D = N + (D - N) / o) : D < L && (D = L - (L - D) / o))),
        (q.startX = T = ba(T)),
        (q.startY = D = ba(D));
    }
    function Gh() {
      ...
      if (
        ...
        if (
          ...
          Ee[e.type]
            ? ((v = ~e.type.indexOf("touch")
              ...
              xa(v, "touchcancel", fe),
              xa(de, "touchstart", Ca))
            : ((v = null), xa(de, "mousemove", ue)),
          (I = null),
          (Le && v) ||
            (xa(de, "mouseup", fe),
            e && e.target && xa(e.target, "mouseup", fe)),
          (y = ae.call(q, e.target) && !1 === p.dragClickables && !t))
        )
          return (
            xa(e.target, "change", fe),
            Oa(q, "pressInit", "onPressInit"),
            Oa(q, "press", "onPress"),
            Ua(Q, !0),
            void (z = !1)
          );
        if (
          ...
          (function _addToRenderQueue(e) {
            Re.push(e), 1 === Re.length && xe.ticker.add(sa);
          })(vh),
          (b = q.pointerY = e.pageY),
          (w = q.pointerX = e.pageX),
          Oa(q, "pressInit", "onPressInit"),
          (B || q.autoScroll) && Ja(h.parentNode),
          !h.parentNode ||
            !q.autoScroll ||
            f ||
            K ||
          ...
          (!p.zIndexBoost && (K || f || !1 === p.zIndexBoost)) ||
          ...
          for (n = Q.length; -1 < --n; )
            xe.set(Q[n], {
              cursor:
                p.activeCursor || p.cursor || ("grab" === Ne ? "grabbing" : Ne),
            });
        Oa(q, "press", "onPress");
      }
    }
    ...
    function Mh(e) {
      ...
      if (
        ...
        return l && r && (c = le), void (H = le);
      (q.isPressed || o || n) && ((l && e.detail && n && !i) || za(e)),
        n ||
          o ||
          W ||
          (e && e.target && (q.pointerEvent = e), Oa(q, "click", "onClick"));
    }
    function Nh(e) {
      return R
        ? {
    ...
    var u,
      ...
      G = ~n.indexOf("x") || ~n.indexOf("y"),
      K = -1 !== n.indexOf("rotation"),
      V = K ? "rotation" : G ? "x" : "left",
      U = G ? "y" : "top",
      ...
      ue = function onMove(e) {
        ...
        if (u && !Me && q.isPressed && e) {
          ...
          B &&
          !I &&
          ((We.x = e.pageX - (ce ? Ea(de) : 0)),
          (We.y = e.pageY - (ce ? Da(de) : 0)),
          R && R.apply(We, We),
          (n = We.x),
          (o = We.y),
          (((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) &&
            ...
            (Xe && B === I)) &&
            ((I = a < i && $ ? "x" : "y"),
            B && I !== B && xa(me, "touchforcechange", za),
            !1 !== q.vars.lockAxisOnTouchScroll &&
              $ &&
              j &&
              ((q.lockedAxis = "x" === I ? "y" : "x"),
              X(q.vars.onLockAxis) && q.vars.onLockAxis.call(q, l)),
            Xe && B === I))
            ? fe(l)
            : ((z =
                q.allowEventDefault ||
      ...
      he = function setPointerPosition(e, t, n) {
        ...
        (q.pointerX = e),
          ...
          K
            ...
            : (R &&
              ...
              (q.lockAxis || q.lockedAxis) &&
                ...
                ((s = q.lockedAxis) ||
                  ((q.lockedAxis = s =
                    $ && Math.abs(o) > Math.abs(r) ? "y" : j ? "x" : null),
                  s &&
                    X(q.vars.onLockAxis) &&
          ...
          E &&
            ...
            K ||
              (N < a
                ? (a = Math.round(N + (a - N) * d))
                : a < L && (a = Math.round(L + (a - L) * d)))),
          (q.x === i && (q.y === a || K)) ||
            (K
              ? ((q.endRotation = q.x = q.endX = i), (P = !0))
              : (j && ((q.y = q.endY = a), (P = !0)),
                $ && ((q.x = q.endX = i), (P = !0))),
            n && !1 === Oa(q, "move", "onMove")
              ? ((q.pointerX = p),
                (q.pointerY = u),
                (D = h),
                (q.x = f),
              ...
              : !q.isDragging &&
                q.isPressed &&
                ((q.isDragging = W = !0), Oa(q, "dragstart", "onDragStart")));
      },
      fe = function onRelease(e, t) {
        if (
          ...
          if (
            ...
            (Le && v) ||
              (ya(de, "mouseup", onRelease),
              e && e.target && ya(e.target, "mouseup", onRelease)),
            (P = !1),
            s && ((ee = Ie = _e()), (q.isDragging = !1)),
            va(vh),
            y && !c)
          )
            return (
              e && (ya(e.target, "change", onRelease), (q.pointerEvent = l)),
              Ua(Q, !1),
              Oa(q, "release", "onRelease"),
              Oa(q, "click", "onClick"),
              void (y = !1)
            );
          for (o = Q.length; -1 < --o; )
            Ka(Q[o], "cursor", p.cursor || (!1 !== p.cursor ? Ne : null));
          if ((Ye--, e)) {
            if (
              (n = e.changedTouches) &&
              (e = n[0]) !== x &&
          ...
          return (
            c && l
              ? (za(l), (z = !0), Oa(q, "release", "onRelease"))
              : l && !s
              ? ((z = !1),
                A && (p.snap || p.bounds) && Ch(p.inertia || p.throwProps),
                Oa(q, "release", "onRelease"),
                (Xe && "touchmove" === l.type) ||
                  -1 !== l.type.indexOf("cancel") ||
                  (Oa(q, "click", "onClick"),
                  _e() - le < 300 && Oa(q, "doubleclick", "onDoubleClick"),
                  (i = l.target || h),
                  (le = _e()),
                  ...
                  Xe || l.defaultPrevented || xe.delayedCall(0.05, a)))
              : (Ch(p.inertia || p.throwProps),
                q.allowEventDefault ||
                !l ||
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var n, o, r, i;
        Hh(e || q.pointerEvent, !0),
          t &&
            !q.hitTest(e || q.pointerEvent) &&
            ((n = Na(e || q.pointerEvent)),
            (o = Na(h)),
            (r = Nh({
              x: n.left + n.width / 2,
              y: n.top + n.height / 2,
      ...
      (e.timeSinceDrag = function () {
        return q.isDragging ? 0 : (_e() - ee) / 1e3;
      }),
      ...
      (e.getDirection = function (e, t) {
        var n,
          ...
          a,
          l,
          s = "velocity" === e && Se ? e : Y(e) && !K ? "element" : "start";
        return (
          "element" === s && ((a = Na(q.target)), (l = Na(e))),
          (n =
            "start" === s
              ? q.x - T
              : "velocity" === s
        ...
        if ((wh(!0), zh(), E && !pe())) {
          if (
            ...
            (q.x !== n || q.y !== o) &&
              ((r = !0),
              (q.x = q.endX = n),
              K ? (q.endRotation = n) : (q.y = q.endY = o),
              vh((P = !0)),
            ...
            for (
              ...
              (a = (l = ze(i.parentNode)) ? He : i.parentNode),
                j &&
                ...
                (i = a);
          q.isThrowing &&
            (r || q.endX > M || q.endX < S || q.endY > N || q.endY < L) &&
            Ch(p.inertia || p.throwProps, r);
        }
        return q;
      }),
      (e.update = function (e, t, n) {
        ...
        return (
          Dh(!t),
          e ? q.applyBounds() : (P && n && vh(!0), wh(!0)),
          t && (he(q.pointerX, q.pointerY), P && vh(!0)),
          q.isPressed &&
            !t &&
            (($ && 0.01 < Math.abs(a - q.x)) ||
              (j && 0.01 < Math.abs(l - q.y) && !K)) &&
            Eh(),
          q.autoScroll &&
            (Ja(h.parentNode, q.isDragging),
            (te = q.isDragging),
            vh(!0),
            Ga(h, Lh),
            Fa(h, Lh)),
      ...
      (e.enable = function (e) {
        ...
        if (
          (!1 !== p.cursor && (r.cursor = p.cursor || Ne),
          ...
          for (
            ...
            (o = Q[n]),
              ...
              p.allowContextMenu || xa(o, "contextmenu", uh);
          Ua(Q, !1);
        }
        return (
          Fa(h, Lh),
          ...
          Se &&
            "soft" !== e &&
            Se.track(f || h, G ? "x,y" : K ? "rotation" : "top,left"),
          (h._gsDragID = t = "d" + Be++),
          (Ae[t] = q),
      ...
      (e.disable = function (e) {
        for (var t, n = q.isDragging, o = Q.length; -1 < --o; )
          Ka(Q[o], "cursor", null);
        if ("soft" !== e) {
        ...
        return (
          ...
          Se &&
            "soft" !== e &&
            Se.untrack(f || h, G ? "x,y" : K ? "rotation" : "top,left"),
          f && f.disable(),
          va(vh),
          (q.isDragging = q.isPressed = y = !1),
          n && Oa(q, "dragend", "onDragEnd"),
          q
        );
      }),
      ...
      ~n.indexOf("scroll") &&
        ...
        (h.style.overflowY = j && !De ? "auto" : "hidden"),
        (h.style.overflowX = $ && !De ? "auto" : "hidden"),
        (h = f.content)),
      K ? (o.rotation = 1) : ($ && (o[V] = 1), j && (o[U] = 1)),
